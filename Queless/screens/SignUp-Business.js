...
import SignupComponent from '../components/SignUpBusinessComponent'; //importerer denne for at bruge den i SignUp skærmen, så vi kan genbruge koden
  ...
  return (
    <SignupComponent
      onSuccess={() => {
        ...
        else navigation.navigate('LoginBusiness'); 
      }}
    />
  );
}
